...
const columns = [
  ...
  {
    title: 'FTPfingerprint',
    dataIndex: 'FTPfingerprint',
    width: 350
  },
  {
    title: '关联域名',
...
for (let i = 0; i < 100; i++) {
  data.push({
    key: i,
    FTPfingerprint: `1b:42:1c:97:f8:cb:0c:6e:b5:b6:32:6c:34:b5:eb:0c`,
    name: 'shield3inlgzw2h3',
    time: `2020-04-05 01:01:${i}`
  })
}
export default {
  components: {
  ...
  methods: {
    ...
    getList () {
      this.$http.get('/list/FTPfingerprint').then(res => {
        console.log('res', res)
